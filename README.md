...
<h3 align="center">OpenVPN Configs Updater</h3>
  ...
  ```html
wget https://github.com/atong27/AutoScriptDS/raw/master/configupdate.sh && chmod +x configupdate.sh && ./configupdate.sh
  ```
<h3 align="center">Installation (Default)</h3>

  ```html
wget https://github.com/atong27/AutoScriptDS/raw/master/DS && chmod +x DS && ./DS
  ```
  
<h3 align="center">Installation (Experimental)</h3>

  ```html
wget https://github.com/atong27/AutoScriptDS/raw/master/DSE && chmod +x DSE && ./DSE
  ```
  
<h3 align="center">Installation (Single Cert Apache)</h3>

  ```html
wget https://github.com/atong27/AutoScriptDS/raw/master/DSCA && chmod +x DSCA && ./DSCA
  ```
  
<h3 align="center">Installation (Single Cert Nginx)</h3>

  ```html
wget https://github.com/atong27/AutoScriptDS/raw/master/DSCAN && chmod +x DSCAN && ./DSCAN
  ```
...
<h3 align="center">Installation (Single Cert w0pw0p)</h3>
  ...
  ```html
wget https://github.com/atong27/AutoScriptDS/raw/master/DSWOP && chmod +x DSWOP && ./DSWOP
  ```

<h3 align="center">Installation OpenVPN-Monitor</h3>

  ```html
wget https://raw.githubusercontent.com/atong27/AutoScriptDS/master/Files/Plugins/ovpnmonitor.sh && chmod +x ovpnmonitor.sh && ./ovpnmonitor.sh
  ```
...
<p align="center">
<img src="https://github.com/atong27/AutoScriptDS/raw/master/Snapshots/1.png">
   </p>
  <p align="center">
  <img src="https://github.com/atong27/AutoScriptDS/raw/master/Snapshots/2.png">
   </p>
  <p align="center">
  <img src="https://github.com/atong27/AutoScriptDS/raw/master/Snapshots/3.png">
  </p>
  <p align="center">
  <img src="https://github.com/atong27/AutoScriptDS/raw/master/Snapshots/4.png">
   </p>
...
```html
wget --no-check-certificate https://raw.githubusercontent.com/atong27/AutoScriptDS/master/Files/Plugins/SSR
chmod +x SSR
